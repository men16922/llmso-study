...
| [articles/WSL2를 로컬 GPU Kubernetes 개발 환경으로 사용하기.md](../../articles/WSL2%EB%A5%BC%20%EB%A1%9C%EC%BB%AC%20GPU%20Kubernetes%20%EA%B0%9C%EB%B0%9C%20%ED%99%98%EA%B2%BD%EC%9C%BC%EB%A1%9C%20%EC%82%AC%EC%9A%A9%ED%95%98%EA%B8%B0.md) ★ | (직접 실측) | WSL2에서 Docker·K3s·DCGM까지 실행한 증빙. 원문과 다른 결과와 트러블슈팅을 기록. **실습 기록이라 `articles/`로 옮겼습니다** |
...
1. **[gpu-setup-docker-k8s](./gpu-setup-docker-k8s.md)** — GPU가 컨테이너/K8s에 어떻게 노출되는지 (기초)
   ...
   - 완료 후 실제 결과와 차이를 확인하려면 → [WSL2 실측 보고서](../../articles/WSL2%EB%A5%BC%20%EB%A1%9C%EC%BB%AC%20GPU%20Kubernetes%20%EA%B0%9C%EB%B0%9C%20%ED%99%98%EA%B2%BD%EC%9C%BC%EB%A1%9C%20%EC%82%AC%EC%9A%A9%ED%95%98%EA%B8%B0.md)
