...
스터디 진행: **1·2주차 완료·제출 완료. 3주차(CH5·CH6) 측정 3종 + 글 + 노션 발행 완료 — 링크 공유만 남음.**

## Active Focus

Authority: `docs/NEXT_PLAN.md`.

0. **3주차 과제 제출** — 노션 발행 완료(https://app.notion.com/p/3c44c2420ac48157aaebe78f971e05c9). **남은 것은 링크 공유뿐.** 마감 **2026-08-23 09:00**.
1. 그다음: 4주차 예습 노트.

## Open Risks

- **과제 미공유 1회 = 제명.** 다음 마감 **2026-08-23(일) 09:00**. 발행까지 끝났고 **공유만 남았습니다.**
