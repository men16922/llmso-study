...
>
> ▶ **5주차 (CH9·CH10) — 09-05 원고·노션 구조·근거 개정 완료.** 마감 **2026-09-06(일) 09:00**. 첫 작업은 원고가 참조하는 `results/f*` 원본 확보·대조이며 제출표 공유는 미확인입니다. 기존 실험의 완료 여부는 원본 대조 없이 확정하지 않습니다.
...
결과 요약은 `docs/COMPLETED_SUMMARY.md`의 **M3**, 상세 이력은 [`docs/archive/progress-2026-08.md`](../progress-2026-08.md)(08-22·08-23 항목), 설계·근거·함정은 [`docs/plans/2026-08-16-week3-triton-rayserve.md`](../../plans/2026-08-16-week3-triton-rayserve.md)에 있습니다. 여기에는 **이월분만** 남깁니다.
...
과제 제출은 `docs/COMPLETED_SUMMARY.md`의 **M2**, 실습 도구 일체는 **M4**, 상세 이력은 [`docs/archive/progress-2026-08.md`](../progress-2026-08.md)(08-15·08-16 항목). 여기에는 **이월분만** 남깁니다.
