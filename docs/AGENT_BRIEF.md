...
> ▶ NEXT SESSION: **2주차 과제 링크 2개를 공유.** 마감 **2026-08-16 09:00**. 글 2편이 모두 노션에 발행돼 있고 남은 것은 공유뿐입니다 — ① `WSL2를 로컬 GPU Kubernetes 개발 환경으로 사용하기` ② `Continuous Batching이 처리량을 높이는 방식`(두 글은 「다음 편」·「이 글의 배경」으로 양방향 연결). 링크드인 포스트 초안은 `post/2주차-과제-LinkedIn-포스트.md`(사용자 작성). 그다음은 **3주차(CH5·CH6) 예습 노트**, 모임 08-16 20:30.
>
...
1. 과제용 글 작성 — 마감은 **매주 일요일 09:00**, 미공유 1회 = 제명. **2주차는 2편 시리즈로 발행 완료 — 링크 공유만 남음.**
