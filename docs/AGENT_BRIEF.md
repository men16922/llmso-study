...
> 발행본: https://app.notion.com/p/3c44c2420ac48157aaebe78f971e05c9 (윤문·발행·전 수치 대조까지 완료). 원고는 [`articles/처리량의 천장은 어디에 있었나.md`](../articles/%EC%B2%98%EB%A6%AC%EB%9F%89%EC%9D%98%20%EC%B2%9C%EC%9E%A5%EC%9D%80%20%EC%96%B4%EB%94%94%EC%97%90%20%EC%9E%88%EC%97%88%EB%82%98.md).
...
1. **3주차 과제 — 측정 3종 + 글 + 노션 발행 완료. 링크 공유만 남음.** 결론 셋: 계층이 처리량 천장을 정하고 있었다(**−32.6%**, 고정이 아니라 포화 후 31%) · KV cache는 상한을 정하지만 그게 처리량은 아니다(노브가 4.5배 흔들려도 ±17%) · dynamic batching은 노브가 아니라 **도착률의 함수**.
