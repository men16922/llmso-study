...
<details>
<summary>용어 정리 — 처리량·ITL·TTFT와 KV 예산</summary>

이 글에서는 **얼마나 많이 생성했는지**, **얼마나 빨리 토큰이 이어지는지**, **첫 토큰까지 얼마나 기다렸는지**를 구분합니다.
...
## 1. KV Cache를 줄여도 처리량 이득은 남았다

**FP8은 유지하고 KV 예산만 줄였습니다. 그래도 처리량은 BF16보다 높았습니다.**

<details>
<summary>가설 — 왜 KV Cache 용량을 줄였나</summary>
...
<details>
<summary>대조 실험 — 세 구성의 조건과 반복 측정 결과</summary>
...
<details>
<summary>실험 환경·전체 결과·기동 로그</summary>
...
## 2. 동시 요청 수는 같고, 토큰 간격은 짧아졌다

**실행 요청 수가 같아도 처리량은 늘었습니다. ITL도 짧아져, 토큰을 처리하는 시간이 줄었다는 해석을 뒷받침했습니다.**

<details>
<summary>실측 근거 — Prometheus 처리량·동시 요청 수와 ITL</summary>

ITL p50은 **9.7ms→7.3ms(−24.7%)**였습니다.
...
<details>
<summary>Prometheus 측정 조건과 A·B·C 구간 구분</summary>
...
<details>
<summary>집계 검증 — 단위 차이와 역할별 커널 분석</summary>
...
<details>
<summary>KV 예산별 전체 결과와 부족 구간</summary>
...
<details>
<summary>다른 워크로드·동시성에서는 얼마나 달라졌나</summary>
...
<details>
<summary>재현 조건과 후속 검증 절차</summary>
