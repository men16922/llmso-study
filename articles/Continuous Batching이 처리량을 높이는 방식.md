...
![Prometheus 콘솔 — B2 구간의 num_requests_running(초록)과 num_requests_waiting(청록). running은 4에서 16으로 증가한 뒤 유지되고, 02:21에 waiting은 48로 증가한다](./screenshots/proof-01-queue-running-waiting.jpg)
